...
public class WeaponSystem : MonoBehaviour, IPunObservable
{
    ...
    IEnumerator CoolTimeLoad()
    {
        ...
        while (i < 10)
        {
            ...
            castbarXY.offsetMin = new Vector2(637.0f, 1618.0f + 500.0f);
            castbarXY.offsetMax = new Vector2(-2037.0f, -618.0f + 500.0f - (i * 50.0f));

            //castbarXY.sizeDelta = new Vector2(i * 10.0f, f);
            yield return new WaitForSeconds(CoolTime / 10.0f);
        }
